...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {uid: a, name: b, info: c, date: d, datePicker: e, isNew: f, hasEdited: g, trips: h};
	});
...
var _user$project$Main$upsertTrip = function (trip) {
	...
	var _p2 = _elm_lang$core$Debug$log(
		A2(_elm_lang$core$Basics_ops['++'], 'upsertTrip uid:', trip.uid));
			...
			switch (_p4.ctor) {
				...
				case 'Add':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{uid: '', name: '', info: '', isNew: true, hasEdited: false, trips: model.trips}),
						{
							ctor: '::',
							_0: A2(
								_elm_lang$core$Random$generate,
				...
				case 'FetchTrip':
					if (_p4._0.ctor === 'Ok') {
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{uid: _p11.uid, name: _p11.name, info: _p11.info, isNew: false, hasEdited: false}),
							{ctor: '[]'});
					} else {
				...
				case 'NewUid':
					...
					return A2(
						...
						{ctor: '[]'});
				default:
					var _p17 = A2(_Bogdanp$elm_datepicker$DatePicker$update, _p4._0, model.datePicker);
					var newDatePicker = _p17._0;
...
var _user$project$Main$fetchTrips = function () {
	...
	var _p19 = _elm_lang$core$Debug$log('fetchTrips');
...
var _user$project$Main$init = function (flags) {
	...
	var _p20 = _Bogdanp$elm_datepicker$DatePicker$init(
		_elm_lang$core$Native_Utils.update(
			_Bogdanp$elm_datepicker$DatePicker$defaultSettings,
			{placeholder: 'Pick a date...', isDisabled: isDisabled}));
...
var _user$project$Main$viewTrips = function (trips) {
	var _p21 = A2(_elm_lang$core$Debug$log, 'ViewTrips ', trips);
	return A2(
