...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {uid: a, name: b, info: c, trips: d};
	});
		...
		switch (_p4.ctor) {
			...
			case 'Add':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{uid: '', name: '', info: '', trips: model.trips}),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$core$Random$generate,
			...
			case 'Edit':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{uid: _p5, name: t.name, info: t.info}),
					{ctor: '[]'});
			case 'Name':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'FetchTrip':
				if (_p4._0.ctor === 'Ok') {
					var _p10 = _p4._0._0;
					var _p9 = A2(_elm_lang$core$Debug$log, 'FetchTrip ok', _p10);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{uid: _p10.uid, name: _p10.name, info: _p10.info}),
						{ctor: '[]'});
				} else {
					var _p11 = A2(_elm_lang$core$Debug$log, 'FetchTrip err', _p4._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'UpdateTrip':
				if (_p4._0.ctor === 'Ok') {
					...
					var updateTrip = function (t) {
						return _elm_lang$core$Native_Utils.eq(t.uid, _p13.uid) ? _elm_lang$core$Native_Utils.update(
							t,
							{name: _p13.name, info: _p13.info}) : t;
					};
					var _p12 = A2(_elm_lang$core$Debug$log, 'UpdateTrip ok', _p13);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
					...
					var _p14 = A2(_elm_lang$core$Debug$log, 'UpdateTrip err', _p4._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			default:
				var _p15 = _p4._0;
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							trips: A2(
								...
								{
									ctor: '::',
									_0: A3(_user$project$Main$newTrip, _p15, model.name, model.info),
									_1: {ctor: '[]'}
								})
						}),
					{ctor: '[]'});
...
var _user$project$Main$fetchTrips = function () {
	...
	var _p16 = _elm_lang$core$Debug$log('fetchTrips');
...
var _user$project$Main$viewTrip = function (trip) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(trip.name),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$viewTrips = function (trips) {
	var _p17 = A2(_elm_lang$core$Debug$log, 'ViewTrips ', trips);
	return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Trip ID:', model.uid)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
