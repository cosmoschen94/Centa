...
var _simonh1000$elm_jwt$Jwt$createRequest = F5(
...
var _simonh1000$elm_jwt$Jwt$decodeToken = F2(
	function (dec, token) {
		var f1 = A2(
			_elm_lang$core$String$split,
			'.',
			_simonh1000$elm_jwt$Jwt$unurl(token));
		var f2 = A2(_elm_lang$core$List$map, _simonh1000$elm_jwt$Jwt$fixlength, f1);
		var _p2 = f2;
		_v2_2:
		do {
					...
					if ((_p2._1._1.ctor === '::') && (_p2._1._1._1.ctor === '[]')) {
						...
						if (_p3.ctor === 'Ok') {
							...
							if (_p4.ctor === 'Ok') {
								...
								return _elm_lang$core$Result$Err(
									_simonh1000$elm_jwt$Jwt$TokenDecodeError(_p4._0));
							}
						} else {
							return _elm_lang$core$Result$Err(
								_simonh1000$elm_jwt$Jwt$TokenProcessingError(_p3._0));
						}
					} else {
						break _v2_2;
					}
...
var _simonh1000$elm_jwt$Jwt$checkUnacceptedToken = F2(
	function (token, now) {
		var _p5 = A2(_simonh1000$elm_jwt$Jwt$isExpired, now, token);
		if (_p5.ctor === 'Ok') {
			if (_p5._0 === true) {
...
var _simonh1000$elm_jwt$Jwt$checkTokenExpirey = function (token) {
	return A2(
		_elm_lang$core$Task$andThen,
		function (_p6) {
			return _elm_lang$core$Task$succeed(
				A2(_simonh1000$elm_jwt$Jwt$checkUnacceptedToken, token, _p6));
		},
...
var _simonh1000$elm_jwt$Jwt$promote401 = function (err) {
	var _p7 = err;
	if (_p7.ctor === 'BadStatus') {
		return _elm_lang$core$Native_Utils.eq(_p7._0.status.code, 401) ? _simonh1000$elm_jwt$Jwt$Unauthorized : _simonh1000$elm_jwt$Jwt$HttpError(err);
	} else {
		return _simonh1000$elm_jwt$Jwt$HttpError(err);
	}
};
var _simonh1000$elm_jwt$Jwt$conv = function (fn) {
	return function (_p8) {
		return fn(
			A2(_elm_lang$core$Result$mapError, _simonh1000$elm_jwt$Jwt$promote401, _p8));
	};
};
var _simonh1000$elm_jwt$Jwt$send = F2(
	function (msgCreator, req) {
		return A2(
			...
			_simonh1000$elm_jwt$Jwt$conv(msgCreator),
			req);
	});
var _simonh1000$elm_jwt$Jwt$handleError = F2(
	function (token, err) {
		var _p9 = _simonh1000$elm_jwt$Jwt$promote401(err);
		if (_p9.ctor === 'Unauthorized') {
			return _simonh1000$elm_jwt$Jwt$checkTokenExpirey(token);
		} else {
			return _elm_lang$core$Task$succeed(
			...
			A2(
				...
				function (_p10) {
					return A2(
						...
						A2(_simonh1000$elm_jwt$Jwt$handleError, token, _p10));
				},
				A2(
					_elm_lang$core$Task$map,
...
var _user$project$Main$init = function (savedModel) {
	return {
		...
		_1: _user$project$Flow$getTrips
	};
};
...
var _user$project$Main$updateWithStorage = F2(
	function (msg, model) {
		var _p0 = A2(_user$project$Flow$update, msg, model);
		var newModel = _p0._0;
		var cmds = _p0._1;
		return {
			ctor: '_Tuple2',
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					_0: _user$project$Main$setStorage(newModel),
					_1: {
						ctor: '::',
						_0: cmds,
						_1: {ctor: '[]'}
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Main$init, view: _user$project$View$view, update: _user$project$Main$updateWithStorage, subscriptions: _user$project$Main$subscriptions})(
